...
fluid.defaults("adaptiveContentServices.handlers.dictionary.oxford", {
    ...
    invokers: {
        dictionaryHandlerImpl: {
            funcName: "adaptiveContentServices.handlers.dictionary.oxford.getDefinition",
            args: ["{arguments}.0", "{arguments}.1", "{arguments}.2", "{arguments}.3", "{that}"]
        },
        definitionImpl: "adaptiveContentServices.handlers.dictionary.oxford.definition",
...
//Oxford-specific handler
adaptiveContentServices.handlers.dictionary.oxford.getDefinition = function (request, version, word, lang, that) {
    try {
...
adaptiveContentServices.handlers.dictionary.oxford.definition = function (lang, word) {
    var promise = fluid.promise();
